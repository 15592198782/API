...
def create_repo(github,name,org=None,description=None,hompage=None,private=False,has_issues=True,
...
def create_branch(github,owner,repo,new_branch_name,source_branch_name):
    ...
    if response.status_code != 200:
        result.success = False
        result.error = "get source branch sha fails,repo={} got {},should be 200".format(repo,str(response.status_code))
        result.response = response
        return result
